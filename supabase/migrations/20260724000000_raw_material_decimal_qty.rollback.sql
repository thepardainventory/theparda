-- Rollback for 20260724000000_raw_material_decimal_qty.sql
--
-- WARNING: if any raw_materials/raw_material_transactions row has a
-- fractional quantity at rollback time, truncating back to integer will
-- round it down (via ::integer cast) and that precision is permanently lost.
